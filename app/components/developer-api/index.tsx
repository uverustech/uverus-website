...
export const DeveloperAPI = () => {
  return (
    <section className="container px-4 md:px-10 lg:px-20 mx-auto flex flex-col md:flex-row justify-between py-[250px] gap-10">
      <div className="w-full md:w-1/2 flex flex-col gap-[36px]">
        <h2
          className={`${sfProSemibold.className} max-w-[18ch] text-dark text-[55px] leading-[70px]`}
        >
          {" "}
          <span className="text-primary">Effortless</span> Custom Payments with{" "}
          <span className="text-primary"> Developer-Friendly</span> APIs.
        </h2>
        <p className="max-w-[47ch] text-[#011B33] text-xl">
