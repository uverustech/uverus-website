      ...
      <div className="container mx-auto flex flex-col md:flex-row gap-10">
        ...
        <div className="w-full md:w-[55%] grid grid-cols-2 gap-10">
            {Businesses.map((business) => (
              <div key={business.name} aria-label={`${business.name} Logo`} className="w-full h-full max-h-[300px] max-w-[300px] aspect-square flex justify-center items-center rounded-[10px] bg-white p-5 md:p-10">
                  {business.logo}
              </div>
            ))}
            <div className="w-full h-full max-h-[300px] max-w-[300px] aspect-square flex justify-center items-center text-[#8B8B8B] text-[60px] text-center font-bold p-5 md:p-10">+ more</div>
        </div>
      </div>
    </section>
  );
